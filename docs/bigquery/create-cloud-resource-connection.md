...
使用 Cloud Storage 儲存資料檔案時，建議使用 Cloud Storage [單一區域](https://docs.cloud.google.com/storage/docs/locations?hl=zh-tw#available-locations)或[雙區域](https://docs.cloud.google.com/storage/docs/locations?hl=zh-tw#location-dr) bucket，以獲得最佳效能，不要使用多區域 bucket。
