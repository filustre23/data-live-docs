...
# 使用 ML.ANNOTATE\_IMAGE 函式為圖片加上註解

本文說明如何搭配[遠端模型](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-remote-model-service?hl=zh-tw)使用 [`ML.ANNOTATE_IMAGE` 函式](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-annotate-image?hl=zh-tw)，為[物件資料表](https://docs.cloud.google.com/bigquery/docs/object-table-introduction?hl=zh-tw)中的圖片加上註解。

## 必要的角色

如要建立遠端模型並為圖片加上註解，您需要在專案層級具備下列 Identity and Access Management (IAM) 角色：
...
- Enable the BigQuery, BigQuery Connection API, and Cloud Vision API APIs.
  ...
  **Roles required to enable APIs**
  ...
  [Enable the APIs](https://console.cloud.google.com/flows/enableapi?apiid=bigquery.googleapis.com%2Cbigqueryconnection.googleapis.com%2Cvision.googleapis.com&hl=zh-tw)
...
使用 [`REMOTE_SERVICE_TYPE`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-remote-model-service?hl=zh-tw#remote_service_type) 建立遠端模型：`CLOUD_AI_VISION_V1`
...
以下範例會偵測圖片中顯示的任何臉部，並傳回圖片屬性，例如主色：
