...
* 如果您是 VPC Service Controls 使用者，請參閱「[VPC Service Controls](https://docs.cloud.google.com/bigquery/docs/analytics-hub-introduction?hl=zh-tw#vpc-service-controls)」。
