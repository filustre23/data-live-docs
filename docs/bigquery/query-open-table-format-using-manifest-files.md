...
* 啟用 BigQuery Connection、BigQuery Reservation 和 BigLake API。
  ...
  **啟用 API 時所需的角色**
  ...
  [啟用 API](https://console.cloud.google.com/apis/enableflow?apiid=bigqueryconnection.googleapis.com%2Cbiglake.googleapis.com%2C%5Cnbigqueryreservation.googleapis.com&%3Bredirect=https%3A%2F%2Fconsole.cloud.google.com&hl=zh-tw)
