...
本文說明 BigQuery 共用 (舊稱 Analytics Hub) 的 Identity and Access Management (IAM) 角色，以及如何授予這些角色。詳情請參閱「[BigQuery 共用角色和權限](https://docs.cloud.google.com/iam/docs/roles-permissions/analyticshub?hl=zh-tw)」。
...
如要[管理資料交換](https://docs.cloud.google.com/bigquery/docs/analytics-hub-manage-exchanges?hl=zh-tw)，BigQuery 共用功能提供[Analytics Hub 管理員角色](https://docs.cloud.google.com/bigquery/docs/access-control?hl=zh-tw#analyticshub.admin) (`roles/analyticshub.admin`)，您可以為 Google Cloud 專案或資料交換授予這個角色。這個角色可讓使用者執行下列操作：
...
* [Analytics Hub 發布者角色](https://docs.cloud.google.com/bigquery/docs/access-control?hl=zh-tw#analyticshub.publisher)
  (`roles/analyticshub.publisher`)，可讓使用者執行下列操作：
...
如要[查看及訂閱清單和資料交換](https://docs.cloud.google.com/bigquery/docs/analytics-hub-view-subscribe-listings?hl=zh-tw)，Sharing 提供下列預先定義的角色，可授予專案、資料交換或清單：

* [Analytics Hub 訂閱者角色](https://docs.cloud.google.com/bigquery/docs/access-control?hl=zh-tw#analyticshub.subscriber) (`roles/analyticshub.subscriber`)，可讓使用者查看及訂閱房源。

  您會透過這個角色成為 *BigQuery 共享訂閱者*。
...
如要[管理訂閱項目](https://docs.cloud.google.com/bigquery/docs/analytics-hub-manage-subscriptions?hl=zh-tw)，Sharing 提供下列預先定義角色，您可以在專案層級授予這些角色：

* [Analytics Hub 訂閱項目擁有者角色](https://docs.cloud.google.com/bigquery/docs/access-control?hl=zh-tw#analyticshub.subscriptionOwner)
...
* 瞭解 [BigQuery sharing](https://docs.cloud.google.com/bigquery/docs/analytics-hub-introduction?hl=zh-tw)。
