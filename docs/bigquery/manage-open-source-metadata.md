...
同樣地，您也可以將批次工作負載提交至 Managed Service for Apache Spark。如要這麼做，請按照[批次工作負載操作說明](https://docs.cloud.google.com/dataproc-serverless/docs/quickstarts/spark-batch?hl=zh-tw#submit_a_spark_batch_workload)，新增下列額外旗標：
