...
如要查看查詢 Amazon S3 BigLake 表格的確切必要權限，請展開「必要權限」部分：
...
建立 Amazon S3 BigLake 資料表後，您可以使用 [GoogleSQL 語法查詢](https://docs.cloud.google.com/bigquery/docs/running-queries?hl=zh-tw)，就像查詢標準 BigQuery 資料表一樣。
