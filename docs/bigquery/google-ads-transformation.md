...
| ad\_group\_ad\_ad\_legacy\_responsive\_display\_ad\_main\_color | The main color of the ad in hexadecimal, For example #ffffff for white. If one of main\_color and accent\_color is set, the other is required as well. | MainCol |