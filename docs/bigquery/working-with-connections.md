...
* [查看連線詳細資料](#view-connections)：
  資料集上的 [BigQuery Connection 使用者](https://docs.cloud.google.com/iam/docs/roles-permissions/bigquery?hl=zh-tw#bigquery.connectionUser)  (`roles/bigquery.connectionUser`)
...
* [刪除連線](#delete-connections)：
  連線的「BigQuery 連線管理員」 (`roles/bigquery.connectionAdmin`)
