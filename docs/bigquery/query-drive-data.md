...
建立雲端硬碟外部資料表後，您可以使用 [GoogleSQL 語法查詢該資料表](https://docs.cloud.google.com/bigquery/docs/running-queries?hl=zh-tw)，就像查詢標準 BigQuery 資料表一樣。例如：`SELECT field1, field2
