...
# 載入 Google Play 資料 透過集合功能整理內容 你可以依據偏好儲存及分類內容。

安排從 Google Play 報表資料到 BigQuery 的週期性載入工作。

## 深入探索

如需包含這個程式碼範例的詳細說明文件，請參閱下列文章：

* [將 Google Play 資料載入 BigQuery](https://docs.cloud.google.com/bigquery/docs/play-transfer?hl=zh-tw)
