...
# 使用永久資料表來查詢 Bigtable 透過集合功能整理內容 你可以依據偏好儲存及分類內容。

建立永久資料表，查詢 Bigtable 執行個體的資料。

## 深入探索

如需包含這個程式碼範例的詳細說明文件，請參閱下列文章：

* [建立 Bigtable 外部資料表](https://docs.cloud.google.com/bigquery/docs/create-bigtable-external-table?hl=zh-tw)
