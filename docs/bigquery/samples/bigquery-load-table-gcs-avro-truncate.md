...
# 載入 Avro 檔案來替換資料表 透過集合功能整理內容 你可以依據偏好儲存及分類內容。

從 Cloud Storage 載入 Avro 檔案，取代現有資料表資料。

## 深入探索

如需包含這個程式碼範例的詳細說明文件，請參閱下列文章：

* [從 Cloud Storage 載入 Avro 資料](https://docs.cloud.google.com/bigquery/docs/loading-data-cloud-storage-avro?hl=zh-tw)
