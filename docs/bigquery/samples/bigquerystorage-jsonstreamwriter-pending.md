...
# 附加待處理的記錄 透過集合功能整理內容 你可以依據偏好儲存及分類內容。

使用 JSON 串流寫入器附加待處理的記錄。

## 深入探索

如需包含這個程式碼範例的詳細說明文件，請參閱下列文章：

* [使用 Storage Write API 批次載入資料](https://docs.cloud.google.com/bigquery/docs/write-api-batch?hl=zh-tw)
* [使用 Storage Write API 批次載入資料](https://docs.cloud.google.com/bigquery/docs/write-api-batch-load?hl=zh-tw)
