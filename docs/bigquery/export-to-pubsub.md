...
* [Pub/Sub 檢視者 (`roles/pubsub.viewer`)](https://docs.cloud.google.com/iam/docs/roles-permissions/pubsub?hl=zh-tw#pubsub.viewer)
...
* 匯出的資料必須包含單一 [`STRING`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/data-types?hl=zh-tw#string_type) 或 [`BYTES`](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/data-types?hl=zh-tw#bytes_type) 欄。資料欄名稱可自行選擇。
