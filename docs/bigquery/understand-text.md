...
- Enable the BigQuery, BigQuery Connection API, and Cloud Natural Language API APIs.
  ...
  **Roles required to enable APIs**
  ...
  [Enable the APIs](https://console.cloud.google.com/flows/enableapi?apiid=bigquery.googleapis.com%2Cbigqueryconnection.googleapis.com%2Clanguage.googleapis.com&hl=zh-tw)
