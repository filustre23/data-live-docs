...
BigQuery ML 和 Vertex AI 都提供可解釋 AI 服務，可提供特徵式解釋。您可以在 BigQuery ML 中執行可解釋性功能，也可以在 Agent Platform 中[註冊模型](https://docs.cloud.google.com/bigquery/docs/managing-models-vertex?hl=zh-tw#register_models)，然後在該處執行可解釋性功能。
...
**注意：** 可解釋 AI 會產生少許額外費用。如要瞭解詳情，請參閱 [Vertex AI 定價](https://cloud.google.com/vertex-ai/pricing?hl=zh-tw)。
