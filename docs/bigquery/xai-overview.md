...
如要瞭解如何對 Model Registry 中的模型使用 XAI，請參閱「[使用已部署的模型取得線上說明](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/get-online-predictions?hl=zh-tw#online-explanation)」。
