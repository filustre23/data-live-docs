...
# Method: projects.locations.connections.list Stay organized with collections Save and categorize content based on your preferences.
...
| JSON representation |
| --- |
| ``` {   "nextPageToken": string,   "connections": [     {       object (Connection)     }   ] } ``` |

| Fields | |
| --- | --- |
| `nextPageToken` | `string`  Next page token. |
| `connections[]` | `object (Connection)`  List of connections. |
