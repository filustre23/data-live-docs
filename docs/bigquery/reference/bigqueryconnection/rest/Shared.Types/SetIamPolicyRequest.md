...
# SetIamPolicyRequest Stay organized with collections Save and categorize content based on your preferences.
...
| JSON representation |
| --- |
| ``` {   "resource": string,   "policy": {     object (Policy)   },   "updateMask": string } ``` |
