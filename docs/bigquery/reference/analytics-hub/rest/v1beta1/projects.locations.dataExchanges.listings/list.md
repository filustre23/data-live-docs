...
# Method: projects.locations.dataExchanges.listings.list Stay organized with collections Save and categorize content based on your preferences.
...
| JSON representation |
| --- |
| ``` {   "listings": [     {       object (Listing)     }   ],   "nextPageToken": string } ``` |

| Fields | |
| --- | --- |
| `listings[]` | `object (Listing)`  The list of Listing. |
