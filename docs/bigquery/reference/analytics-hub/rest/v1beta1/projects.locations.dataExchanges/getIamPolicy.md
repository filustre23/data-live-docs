...
# Method: projects.locations.dataExchanges.getIamPolicy Stay organized with collections Save and categorize content based on your preferences.
...
| Fields | |
| --- | --- |
| `options` | `object (GetPolicyOptions)`  OPTIONAL: A `GetPolicyOptions` object for specifying options to `dataExchanges.getIamPolicy`. |
