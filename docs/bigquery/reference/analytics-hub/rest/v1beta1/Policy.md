...
For sampleservice, this policy enables DATA\_READ, DATA\_WRITE and ADMIN\_READ logging. It also exempts [jose@example.com](mailto:jose@example.com) from DATA\_READ logging, and [aliya@example.com](mailto:aliya@example.com) from DATA\_WRITE logging.
