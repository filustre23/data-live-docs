...
# DiscoveryType Stay organized with collections Save and categorize content based on your preferences.
...
| Enums | |
| --- | --- |
| `DISCOVERY_TYPE_UNSPECIFIED` | Unspecified. Defaults to DISCOVERY\_TYPE\_PRIVATE. |
