...
# Method: projects.locations.dataExchanges.queryTemplates.list Stay organized with collections Save and categorize content based on your preferences.
...
| JSON representation |
| --- |
| ``` {   "queryTemplates": [     {       object (QueryTemplate)     }   ],   "nextPageToken": string } ``` |

| Fields | |
| --- | --- |
| `queryTemplates[]` | `object (QueryTemplate)`  The list of QueryTemplates. |
