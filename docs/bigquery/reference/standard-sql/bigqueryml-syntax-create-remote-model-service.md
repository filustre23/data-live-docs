...
[Agent Platform User role](/gemini-enterprise-agent-platform/machine-learning/general/access-control#aiplatform.user)
...
* Use [Workbench](https://console.cloud.google.com/ai/document-ai/workbench) to build a
  ...
  based on an Gemini Enterprise Agent Platform
  [foundation model](/gemini-enterprise-agent-platform/models/google-models#foundation_model_apis).
