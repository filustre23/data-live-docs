...
| [`RANK`](/bigquery/docs/reference/standard-sql/numbering_functions#rank) | Gets the rank (1-based) of each row within a window. |
| [`ROW_NUMBER`](/bigquery/docs/reference/standard-sql/numbering_functions#row_number) | Gets the sequential row number (1-based) of each row within a window. |
