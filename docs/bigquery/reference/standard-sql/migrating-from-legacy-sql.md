...
|  |  |  |
| --- | --- | --- |
| * `ALL` * `AND` * `ANY` * `ARRAY` * `ASSERT_ROWS_MODIFIED` * `AT` * `COLLATE` * `CURRENT` * `DEFAULT` * `DESC` * `END` * `ENUM` | * `ESCAPE` * `EXCEPT` * `EXCLUDE` * `EXTRACT` * `FETCH` * `FOR` * `GROUP` * `GROUPING` * `GROUPS` * `IF` * `INTERVAL` * `IS` | * `LATERAL` |