...
# Method: transferLogs.list Stay organized with collections Save and categorize content based on your preferences.
...
| `messageTypes[]` | `enum (MessageSeverity)`  Message types to return. If not populated - INFO, WARNING and ERROR messages are returned. |
