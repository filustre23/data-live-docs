...
# Method: projects.locations.catalogs.databases.tables.get Stay organized with collections Save and categorize content based on your preferences.
...
| Parameters | |
| --- | --- |
| `name` | `string`  Required. The name of the table to retrieve. Format: projects/{project\_id\_or\_number}/locations/{locationId}/catalogs/{catalogId}/databases/{databaseId}/tables/{tableId} |
