...
# Method: projects.locations.catalogs.databases.locks.create Stay organized with collections Save and categorize content based on your preferences.
...
| Parameters | |
| --- | --- |
| `parent` | `string`  Required. The parent resource where this lock will be created. Format: projects/{project\_id\_or\_number}/locations/{locationId}/catalogs/{catalogId}/databases/{databaseId} |
