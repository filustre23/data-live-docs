...
# Method: projects.locations.catalogs.databases.locks.delete Stay organized with collections Save and categorize content based on your preferences.
...
| Parameters | |
| --- | --- |
| `name` | `string`  Required. The name of the lock to delete. Format: projects/{project\_id\_or\_number}/locations/{locationId}/catalogs/{catalogId}/databases/{databaseId}/locks/{lock\_id} |
