...
# Method: projects.locations.reservations.assignments.getIamPolicy Stay organized with collections Save and categorize content based on your preferences.
...
| Parameters | |
| --- | --- |
| `options` | `object (GetPolicyOptions)`  OPTIONAL: A `GetPolicyOptions` object for specifying options to `assignments.getIamPolicy`. |
