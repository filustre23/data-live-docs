...
* [AutoML 模型](https://docs.cloud.google.com/bigquery/docs/reference/standard-sql/bigqueryml-syntax-create-automl?hl=zh-tw)：將 `MODEL_TYPE` 選項設為 `AUTOML_REGRESSOR`，即可使用 [AutoML 分類模型](https://docs.cloud.google.com/gemini-enterprise-agent-platform/machine-learning/tabular-data/classification-regression/overview?hl=zh-tw)。
