...
* To share suggestions for new features or improvements, reach out to [support@hex.tech](mailto:support@hex.tech).
...
Use the in product feedback buttons to report bugs or issues. Our team reviews these reports daily. If you want to share suggestions for new features or improvements, reach out to us directly at [support@hex.tech](mailto:support@hex.tech).
