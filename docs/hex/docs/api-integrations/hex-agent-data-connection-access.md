...
* External integration data connection controls apply to both the [Hex Agent in Slack](/docs/share-insights/hex-agent-in-slack) and the [Hex MCP Server](/docs/api-integrations/mcp-server).
...
Configure **External integration data connection access** in either:

1. **Settings** → **Integrations** → **External integration data connection access**
