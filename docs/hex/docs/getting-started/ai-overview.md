...
* All [paid plans](https://hex.tech/pricing) include monthly per-seat [credit grants](/docs/administration/credits) that can be used towards Hex AI features.
...
### Generative Apps (beta)[​](#generative-apps-beta "Direct link to Generative Apps (beta)")
...
### Chat With App Agent[​](#chat-with-app-agent "Direct link to Chat With App Agent")
...
* [Core capabilities](#core-capabilities)
  + [Generative Apps (beta)](#generative-apps-beta)
  + [Notebook Agent](#notebook-agent)
  + [Threads](#threads)
  + [Chat With App Agent](#chat-with-app-agent)
