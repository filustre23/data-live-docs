...
Hex is compliant with the CAN-SPAM Act: Hex users may easily unsubscribe from Hex marketing and sales communications. Data subject access requests for Hex users may be sent to [[email protected]](/cdn-cgi/l/email-protection#8dfdffe4fbeceef4cde5e8f5a3f9e8eee5). Hex’s [Privacy Policy](/docs/legal/privacy) contains additional information.
