...
Hex is compliant with the CAN-SPAM Act: Hex users may easily unsubscribe from Hex marketing and sales communications. Data subject access requests for Hex users may be sent to [privacy@hex.tech](mailto:privacy@hex.tech). Hex’s [Privacy Policy](/docs/legal/privacy) contains additional information.
