...
Hex is compliant with the CAN-SPAM Act: Hex users may easily unsubscribe from Hex marketing and sales communications. Data subject access requests for Hex users may be sent to [[email protected]](/cdn-cgi/l/email-protection#82f2f0ebf4e3e1fbc2eae7faacf6e7e1ea). Hex’s [Privacy Policy](/docs/legal/privacy) contains additional information.
