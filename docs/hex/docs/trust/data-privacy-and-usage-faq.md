...
Hex is compliant with the CAN-SPAM Act: Hex users may easily unsubscribe from Hex marketing and sales communications. Data subject access requests for Hex users may be sent to [[email protected]](/cdn-cgi/l/email-protection#b6c6c4dfc0d7d5cff6ded3ce98c2d3d5de). Hex’s [Privacy Policy](/docs/legal/privacy) contains additional information.
