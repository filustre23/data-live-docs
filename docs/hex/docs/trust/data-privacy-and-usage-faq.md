...
Hex is compliant with the CAN-SPAM Act: Hex users may easily unsubscribe from Hex marketing and sales communications. Data subject access requests for Hex users may be sent to [[email protected]](/cdn-cgi/l/email-protection#c0b0b2a9b6a1a3b980a8a5b8eeb4a5a3a8). Hex’s [Privacy Policy](/docs/legal/privacy) contains additional information.
