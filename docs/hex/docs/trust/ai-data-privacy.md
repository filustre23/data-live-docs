...
BYOK is currently available only for OpenAI and Anthropic. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#9cefe9ececf3eee8dcf4f9e4b2e8f9fff4) if you're interested in using another provider.
