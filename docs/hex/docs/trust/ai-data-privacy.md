...
BYOK is currently available only for OpenAI and Anthropic. Please reach out to [support@hex.tech](mailto:support@hex.tech) if you're interested in using another provider.
