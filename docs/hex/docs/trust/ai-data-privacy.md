...
BYOK is currently available only for OpenAI and Anthropic. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#8af9fffafae5f8fecae2eff2a4feefe9e2) if you're interested in using another provider.
