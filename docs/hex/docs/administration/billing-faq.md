...
* **ACH / wire transfer** — Bank details (Stripe-managed Wells Fargo virtual accounts) are listed directly on the invoice. Bank details may also be provided by the Hex team if you are paying one of our other bank accounts. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#4b2a390b232e33653f2e2823) if you require validation.
...
Please forward the past due email to [[email protected]](/cdn-cgi/l/email-protection#a2c3d0e2cac7da8cd6c7c1ca) and include:
