...
* **ACH / wire transfer** — Bank details (Stripe-managed Wells Fargo virtual accounts) are listed directly on the invoice. Bank details may also be provided by the Hex team if you are paying one of our other bank accounts. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#9cfdeedcf4f9e4b2e8f9fff4) if you require validation.
...
Please forward the past due email to [[email protected]](/cdn-cgi/l/email-protection#751407351d100d5b0110161d) and include:
