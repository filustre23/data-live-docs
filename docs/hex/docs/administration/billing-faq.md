...
* **ACH / wire transfer** — Bank details (Stripe-managed Wells Fargo virtual accounts) are listed directly on the invoice. Bank details may also be provided by the Hex team if you are paying one of our other bank accounts. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#d0b1a290b8b5a8fea4b5b3b8) if you require validation.
...
If you are having issues, please reach out to [[email protected]](/cdn-cgi/l/email-protection#86e7f4c6eee3fea8f2e3e5ee) and include:
