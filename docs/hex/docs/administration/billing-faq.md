...
Yes. Please contact [billingsupport@hex.tech](mailto:billingsupport@hex.tech) with your workspace URL and nonprofit documentation.
...
Yes. Please contact [billingsupport@hex.tech](mailto:billingsupport@hex.tech) using your educational email address and include your workspace URL.
...
* **ACH / wire transfer** — Bank details (Stripe-managed Wells Fargo virtual accounts) are listed directly on the invoice. Bank details may also be provided by the Hex team if you are paying one of our other bank accounts. Please reach out to [ar@hex.tech](mailto:ar@hex.tech) if you require validation.
...
If you need assistance confirming or updating your account email, please reach out to [ar@hex.tech](mailto:ar@hex.tech).
...
If your finance team needs confirmation or additional documentation, please reach out to [ar@hex.tech](mailto:ar@hex.tech).
...
Please forward the past due email to [ar@hex.tech](mailto:ar@hex.tech) and include:
...
If you are having issues, please reach out to [ar@hex.tech](mailto:ar@hex.tech) and include:
