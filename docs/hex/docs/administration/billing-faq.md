...
* **ACH / wire transfer** — Bank details (Stripe-managed Wells Fargo virtual accounts) are listed directly on the invoice. Bank details may also be provided by the Hex team if you are paying one of our other bank accounts. Please reach out to [[email protected]](/cdn-cgi/l/email-protection#701102301815085e04151318) if you require validation.
...
If you are having issues, please reach out to [[email protected]](/cdn-cgi/l/email-protection#c8a9ba88a0adb0e6bcadaba0) and include:
