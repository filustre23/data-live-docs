...
Changes made to your directory details can take up to 5 minutes to be reflected in Hex. If your changes take longer than this time to be reflected reach out to [[email protected]](/cdn-cgi/l/email-protection#1a696f6a6a75686e5a727f62346e7f7972)

### Setup steps:[​](#setup-steps "Direct link to Setup steps:")

* In the Hex Administration panel, go to the **Users & groups** panel and scroll down to **Directory sync** — if you don’t see this option then Directory Sync is not currently available for your workspace. Get in touch with us at [`[email protected]`](/cdn-cgi/l/email-protection#bad2dfd6d6d5fad2dfc294cedfd9d2) to change that!
