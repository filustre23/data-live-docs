...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#aad9dfdadac5d8deeac2cfd284decfc9c2) to get a list of projects that are currently using a project data connection.
