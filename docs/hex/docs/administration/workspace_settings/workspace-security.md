...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#8af9fffafae5f8fecae2eff2a4feefe9e2) to get a list of projects that are currently using a project data connection.
