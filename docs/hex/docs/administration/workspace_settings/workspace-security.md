...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#3d4e484d4d524f497d5558451349585e55) to get a list of projects that are currently using a project data connection.
