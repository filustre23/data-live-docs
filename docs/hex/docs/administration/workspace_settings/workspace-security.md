...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#54272124243b2620143c312c7a2031373c) to get a list of projects that are currently using a project data connection.
