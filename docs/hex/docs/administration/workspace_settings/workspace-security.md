...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#4734323737283533072f223f693322242f) to get a list of projects that are currently using a project data connection.
