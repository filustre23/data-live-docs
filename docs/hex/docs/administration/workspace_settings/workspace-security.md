...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#7c0f090c0c130e083c1419045208191f14) to get a list of projects that are currently using a project data connection.
