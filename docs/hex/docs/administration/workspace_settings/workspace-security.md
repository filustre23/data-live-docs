...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#ccbfb9bcbca3beb88ca4a9b4e2b8a9afa4) to get a list of projects that are currently using a project data connection.
