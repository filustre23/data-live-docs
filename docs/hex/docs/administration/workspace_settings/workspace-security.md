...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#7b080e0b0b14090f3b131e03550f1e1813) to get a list of projects that are currently using a project data connection.
