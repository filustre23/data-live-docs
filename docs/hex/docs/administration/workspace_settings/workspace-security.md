...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#f98a8c8989968b8db9919c81d78d9c9a91) to get a list of projects that are currently using a project data connection.
