...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#11626461617e6365517974693f65747279) to get a list of projects that are currently using a project data connection.
