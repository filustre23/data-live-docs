...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#2b585e5b5b44595f6b434e53055f4e4843) to get a list of projects that are currently using a project data connection.
