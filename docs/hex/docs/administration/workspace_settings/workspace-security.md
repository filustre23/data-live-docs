...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#6615131616091412260e031e481203050e) to get a list of projects that are currently using a project data connection.
