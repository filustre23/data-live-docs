...
If disabled, any existing project data connections will continue to work. Reach out to [support](mailto:support@hex.tech) to get a list of projects that are currently using a project data connection.
