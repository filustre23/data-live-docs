...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#9feceaefeff0edebdff7fae7b1ebfafcf7) to get a list of projects that are currently using a project data connection.
