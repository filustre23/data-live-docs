...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#44373134342b3630042c213c6a3021272c) to get a list of projects that are currently using a project data connection.
