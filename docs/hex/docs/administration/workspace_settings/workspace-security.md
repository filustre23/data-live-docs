...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#3f4c4a4f4f504d4b7f575a47114b5a5c57) to get a list of projects that are currently using a project data connection.
