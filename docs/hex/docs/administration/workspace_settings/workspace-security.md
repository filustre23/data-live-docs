...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#bac9cfcacad5c8cefad2dfc294cedfd9d2) to get a list of projects that are currently using a project data connection.
