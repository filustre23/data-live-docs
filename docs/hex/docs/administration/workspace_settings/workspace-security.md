...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#42313732322d3036022a273a6c3627212a) to get a list of projects that are currently using a project data connection.
