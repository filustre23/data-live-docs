...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#3e4d4b4e4e514c4a7e565b46104a5b5d56) to get a list of projects that are currently using a project data connection.
