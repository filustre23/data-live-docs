...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#2655535656495452664e435e085243454e) to get a list of projects that are currently using a project data connection.
