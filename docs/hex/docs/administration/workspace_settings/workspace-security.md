...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#6e1d1b1e1e011c1a2e060b16401a0b0d06) to get a list of projects that are currently using a project data connection.
