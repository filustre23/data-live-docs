...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#5625232626392422163e332e782233353e) to get a list of projects that are currently using a project data connection.
