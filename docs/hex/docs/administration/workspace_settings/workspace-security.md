...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#4e3d3b3e3e213c3a0e262b36603a2b2d26) to get a list of projects that are currently using a project data connection.
