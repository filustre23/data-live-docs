...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#3645434646594442765e534e184253555e) to get a list of projects that are currently using a project data connection.
