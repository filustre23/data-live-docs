...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#2d5e585d5d425f596d4548550359484e45) to get a list of projects that are currently using a project data connection.
