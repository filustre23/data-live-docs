...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#0b787e7b7b64797f4b636e73257f6e6863) to get a list of projects that are currently using a project data connection.
