...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#0f7c7a7f7f607d7b4f676a77217b6a6c67) to get a list of projects that are currently using a project data connection.
