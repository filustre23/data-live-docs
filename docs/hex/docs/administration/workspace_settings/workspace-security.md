...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#fb888e8b8b94898fbb939e83d58f9e9893) to get a list of projects that are currently using a project data connection.
