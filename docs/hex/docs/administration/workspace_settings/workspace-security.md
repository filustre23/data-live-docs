...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#41323431312e3335012924396f35242229) to get a list of projects that are currently using a project data connection.
