...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#04777174746b7670446c617c2a7061676c) to get a list of projects that are currently using a project data connection.
