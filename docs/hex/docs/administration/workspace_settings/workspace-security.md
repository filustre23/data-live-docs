...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#0675737676697472466e637e287263656e) to get a list of projects that are currently using a project data connection.
