...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#deadabaeaeb1acaa9eb6bba6f0aabbbdb6) to get a list of projects that are currently using a project data connection.
