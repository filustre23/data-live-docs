...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#2f5c5a5f5f405d5b6f474a57015b4a4c47) to get a list of projects that are currently using a project data connection.
