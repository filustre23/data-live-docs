...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#75060005051a0701351d100d5b0110161d) to get a list of projects that are currently using a project data connection.
