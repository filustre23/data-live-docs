...
If disabled, any existing project data connections will continue to work. Reach out to [support](/cdn-cgi/l/email-protection#f4878184849b8680b49c918cda8091979c) to get a list of projects that are currently using a project data connection.
