...
Type or paste the email (or a comma-separated list of emails) you wish to add to your workspace. Then select a workspace role from the drop-down menu and click **Add users**. The invited user(s) will receive an invite email from **[[email protected]](/cdn-cgi/l/email-protection#9ef0f1eaf7f8e7def6fbe6b0eafbfdf6)** prompting them to join your workspace. You will see the invited user(s) appear in the **Users** list.
